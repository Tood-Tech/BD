...
INSERT INTO estabelecimento (fkEmpresa, nome, cnpj, telefone, cep) 
...
INSERT INTO totem (fkEstabelecimento, numeroSerial, processador, alertaProcessador, ram, alertaRam, disco, alertaDisco) 
VALUES 
    (1, '123ABC', 'Intel i5', 80, '8GB DDR4', 90, '1TB HDD', 75),
    (1, '456DEF', 'AMD Ryzen 7', 85, '16GB DDR4', 95,  '512GB SSD', 80),
    (2, '789GHI', 'Intel i7', 90, '32GB DDR4', 100,  '2TB HDD', 85),
    (2, '012JKL', 'AMD Ryzen 9', 95, '64GB DDR4', 80,  '1TB SSD', 90),
    (3, '345MNO', 'Intel i9', 100, '128GB DDR4', 120,  '4TB HDD', 100),
    (3, '678PQR', 'AMD Threadripper 3990X', 78, '256GB DDR4', 130, '2TB SSD', 86),
    (1, '901STU', 'Intel Pentium G4560', 70, '4GB DDR4', 60, '256GB HDD', 50),
    (2, '234VWX', 'AMD Athlon 3000G', 75, '8GB DDR4', 70, '512GB HDD', 65),
    (3, '567YZA', 'Intel Celeron G5900', 65, '4GB DDR4', 55, '128GB SSD', 45),
    (3, '890BCD', 'AMD A4-5300', 60, '4GB DDR3', 50, '500GB HDD', 40);
